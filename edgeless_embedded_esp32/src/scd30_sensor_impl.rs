...
pub struct SCD30SensorWrapper<Conn: sensor_scd30::base::Base<Err>, Delay: embedded_hal::delay::DelayNs, Err: core::fmt::Debug> {
    pub sensor: sensor_scd30::Scd30<Conn, Delay, Err>,
}

impl<Conn: sensor_scd30::base::Base<Err>, Delay: embedded_hal::delay::DelayNs, Err: core::fmt::Debug>
