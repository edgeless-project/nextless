...
mod test {
    ...
    fn port_weights_different_rates() {
        ...
        let (logical_component_under_test, instances_under_test) =
            multi_output_materialized_actor("test1".to_string(), component_id, (colocated_other_id, 1.0), (remote_other_id, 9.0));
    ...
    fn port_weights_different_rates_rounding() {
        ...
        let (logical_component_under_test, instances_under_test) =
            multi_output_materialized_actor("test1".to_string(), component_id, (colocated_other_id, 1.05), (remote_other_id, 9.05));
    ...
    fn port_link_cost_both_local() {
        ...
        let (_component_under_test, instances_under_test) =
            multi_output_materialized_actor("test1".to_string(), component_id, (colocated_other_id, 5.0), (colocated_other_id2, 5.0));
        let port_link_costs = dynamic_port_link_cost(instances_under_test[0].1.try_unpack_active().unwrap(), std::time::Duration::from_secs(60));
        let port_link_costs = port_link_costs.unwrap();
        assert_eq!(port_link_costs.len(), 2);
        assert_eq!(
    ...
    fn port_link_cost_both_remote() {
        ...
        let (_component_under_test, instances_under_test) =
            multi_output_materialized_actor("test1".to_string(), component_id, (remote_other_id2, 5.0), (remote_other_id, 5.0));
        let port_link_costs = dynamic_port_link_cost(instances_under_test[0].1.try_unpack_active().unwrap(), std::time::Duration::from_secs(60));
        let port_link_costs = port_link_costs.unwrap();
        assert_eq!(port_link_costs.len(), 2);
        assert_eq!(
    ...
    fn traffic_locality_all_remote() {
        ...
        let (_component_under_test, instances_under_test) =
            multi_output_materialized_actor("test1".to_string(), component_id, (remote_other_id, 5.0), (remote_other_id2, 5.0));
        let port_link_costs = trafic_locality(instances_under_test[0].1.try_unpack_active().unwrap(), std::time::Duration::from_secs(60));
    ...
    fn traffic_locality_split() {
        ...
        let (_component_under_test, instances_under_test) =
            multi_output_materialized_actor("test1".to_string(), component_id, (remote_other_id, 5.0), (colocated_other_id, 5.0));
        let port_link_costs = trafic_locality(instances_under_test[0].1.try_unpack_active().unwrap(), std::time::Duration::from_secs(60));
