...
pub struct LogicalOverlayDestinationPort {
    pub sources: std::collections::BTreeSet<crate::ir::interaction::LogicalPortId>,
}
...
pub enum DestinationMapping {
    ...
    Anycast(std::collections::BTreeSet<crate::ir::interaction::LogicalPortId>),
    Multicast(std::collections::BTreeSet<crate::ir::interaction::LogicalPortId>),
}
...
impl super::InteractionPortUtils<crate::ir::interaction::LogicalPortId> for LogicalOverlayDialect {
    fn ports_to_interaction(
        ...
        let mut collector =
            std::collections::BTreeMap::<DestinationMapping, std::collections::BTreeSet<crate::ir::interaction::LogicalPortId>>::new();
        ...
        match &overlay_mapping.destination {
            DestinationMapping::Unicast(dest_port_id) => {
                dests
                    ...
                    .or_insert_with(|| LogicalOverlayDestinationPort { sources: Default::default() })
                    .sources
...
mod port_interaction_test {
    use crate::ir::interaction::dialect::{AsConcreteDestinationPort, AsConcreteInteraction, AsConcreteSourcePort, InteractionPortUtils};
    ...
    fn single_source_unicast_target() {
        ...
        let input_source_port_mapping = crate::ir::interaction::SourcePortMapping {
            ...
            mapping: Box::new(super::LogicalOverlaySourcePort {
        ...
        let expected_destination_port_mapping = crate::ir::interaction::DestiantionPortMapping {
            dialect_type: dialect_type(),
            mapping: Box::new(super::LogicalOverlayDestinationPort {
        ...
        let expected_interaction_mapping = crate::ir::interaction::InteractionMapping {
            dialect_type: dialect_type(),
            mapping: Box::new(super::LogicalOverlayInteraction {
                destination: super::DestinationMapping::Unicast(input_destination_id.clone()),
                sources: std::collections::BTreeSet::from([input_source_id.clone()]),
            }),
        };

        let input_source_ports: Vec<(crate::ir::interaction::LogicalPortId, crate::ir::interaction::SourcePortMapping)> =
    ...
    fn two_sources_different_unicast_target() {
        ...
        let expected_interaction_mapping1 = super::LogicalOverlayInteraction {
            destination: super::DestinationMapping::Unicast(input_destination_id1.clone()),
            sources: std::collections::BTreeSet::from([input_source_id1.clone()]),
        };

        let expected_interaction_mapping2 = super::LogicalOverlayInteraction {
            destination: super::DestinationMapping::Unicast(input_destination_id2.clone()),
            sources: std::collections::BTreeSet::from([input_source_id2.clone()]),
        };
    ...
    fn port_interaction_roundtrip_test(
        input_source_ports: &[(crate::ir::interaction::LogicalPortId, crate::ir::interaction::SourcePortMapping)],
        input_destination_ports: &[(crate::ir::interaction::LogicalPortId, crate::ir::interaction::DestiantionPortMapping)],
        expected_interactions: &[crate::ir::interaction::InteractionMapping],
        expected_source_ports: &[(crate::ir::interaction::LogicalPortId, crate::ir::interaction::SourcePortMapping)],
        expected_destination_ports: &[(crate::ir::interaction::LogicalPortId, Vec<crate::ir::interaction::DestiantionPortMapping>)],
    ) {
        let dialect_type = dialect_type();

        let result_interactions = super::LogicalOverlayDialect {}
        ...
        for result_interaction in &result_interactions {
            ...
            assert!(parsed_result_interactions.insert(super::LogicalOverlayInteraction::as_concrete(result_interaction.mapping.as_ref()).unwrap()));
        }

        for expected_interaction in expected_interactions {
            assert_eq!(expected_interaction.dialect_type, dialect_type);
            assert!(
                parsed_expected_interactions.insert(super::LogicalOverlayInteraction::as_concrete(expected_interaction.mapping.as_ref()).unwrap())
            );
        }
        ...
        let mut collected_result_destination_ports: std::collections::BTreeMap<
            ...
            std::collections::BTreeSet<super::LogicalOverlayDestinationPort>,
        ...
        for interaction in &result_interactions {
            let (source_ports, destination_ports) = super::LogicalOverlayDialect {}.interaction_to_ports(interaction.clone()).unwrap();
            ...
            for (source_port_id, source_port_mapping) in source_ports {
                ...
                assert!(collected_result_source_ports
                    .insert(
                        ...
                        super::LogicalOverlaySourcePort::as_concrete(source_port_mapping.mapping.as_ref())
                            .unwrap()
                            .clone()
                    )
                    .is_none())
            ...
            for (destination_port_id, destination_port_mapping) in destination_ports {
                ...
                collected_result_destination_ports.entry(destination_port_id.clone()).or_default().insert(
                    super::LogicalOverlayDestinationPort::as_concrete(destination_port_mapping.mapping.as_ref())
                        .unwrap()
                        .clone(),
                );
            }
        ...
        for (expected_source_id, expected_source_mapping) in expected_source_ports {
            ...
            assert!(collected_expected_source_ports
                .insert(
                    ...
                    super::LogicalOverlaySourcePort::as_concrete(expected_source_mapping.mapping.as_ref())
                        .unwrap()
                        .clone()
                )
                .is_none())
        ...
        for (expected_destination_id, expected_destination_mappings) in expected_destination_ports {
            for expected_destination_mapping in expected_destination_mappings {
                ...
                collected_expected_destination_ports
                    ...
                    .or_default()
                    .insert(
                        super::LogicalOverlayDestinationPort::as_concrete(expected_destination_mapping.mapping.as_ref())
                            .unwrap()
                            .clone(),
                    );
            }
    ...
    fn example_port_id(name: &str) -> crate::ir::interaction::LogicalPortId {
        crate::ir::interaction::LogicalPortId {
            port: edgeless_api::function_instance::PortId(name.to_string()),
            // TODO: Might need to change this if we ever put constraints on service names.
            component: uuid::Uuid::new_v4().to_string(),
        }
    }
