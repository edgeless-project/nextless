...
pub(crate) fn mock_function_under_test(
    ...
    let logical_component = crate::ir::logical_model::LogicalComponent::Actor(crate::ir::actor::LogicalActor {
    ...
    let instances = instances
        ...
        .map(|(instance_id, port_statistics)| {
            (
                ...
                crate::ir::PhysicalComponentState::Materialized(Box::new(crate::ir::actor::PhysicalActor {
                    id: instance_id,
...
pub(crate) fn mock_peer_function(
    ...
    let instances = instance_node_ids
        .into_iter()
        .map(|instance_id| {
            (
                instance_id.function_id.clone(),
