...
if command -v rustup > /dev/null; then
    ...
    rustup install nightly-2026-03-15 1> /dev/null
    rustup +nightly-2026-03-15 target add wasm32-unknown-unknown 1> /dev/null
    # rustup run does not work for Cargo used as a crate.
    export RUSTC="$(rustup +nightly-2026-03-15 which rustc)"
