...
impl crate::container_function::ContainerFunctionAPI for ContainerFunctionAPIClient {
...
impl GuestAPIFunctionServer {
    pub fn run(
        container_function_api: Box<dyn crate::container_function::ContainerFunctionAPI + Send>,
